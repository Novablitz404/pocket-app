...
import { BASE_FEE, Horizon, Keypair, Operation, TransactionBuilder, xdr } from 'npm:@stellar/stellar-sdk@^16';
...
import { HORIZON_URL, NETWORK_PASSPHRASE } from '../_shared/network-config.ts';
